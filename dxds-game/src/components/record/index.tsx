        ...
        <div className="w-100% pl-21px pr-5px flex justify-between font-bold box-border ">
          ...
          <div className="bg3-gray relative mt-2px pl-63px pr-14px">
            ...
            <div className="flex items-center">
              <div className="w-26px h-26px rounded-100% bg-[var(--vt-c-main4)] text-16px mr-10px text-center line-height-26px mr-14px">
                {t("B")}
              </div>
              <div className="text-16px mr-33px">
                {numeral(data?.statistics?.bigCount).format("00")}
              </div>
              <div className="w-26px h-26px rounded-100% bg-[var(--vt-c-main2)] text-16px mr-10px text-center line-height-26px mr-14px">
                {t("S")}
              </div>
